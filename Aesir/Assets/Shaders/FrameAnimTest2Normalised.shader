    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_7668 = _Time + _TimeEditor;
...
////// Emissive:
                ...
                return fixed4(finalColor,_SpriteSheet_var.a);
            }
            ENDCG
        }
        Pass {
